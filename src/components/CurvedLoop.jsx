...
const CurvedLoop = ({
    ...
    return (
        <div
            className="flex items-center justify-center w-100vs my-56 text-4xl" // valid padding and margin classes
        ...
        >
            ...
            >
                ...
                {ready && (
                    <text xmlSpace="preserve" className={`opacity-20 fill-amber-50 ${className ?? ""}`}>
